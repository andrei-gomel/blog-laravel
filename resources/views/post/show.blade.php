...
@section('content')
    ...
    <main class="blog-post">
        <div class="container">
            ...
            <p class="edica-blog-post-meta" data-aos="fade-up" data-aos-delay="200">Опубликовал Админ • {{ $date->day }} {{ $date->translatedFormat('F') }} , {{ $date->year }} • {{ $date->format('H:i') }} • Featured • Комментариев ( {{ $post->comments->count() }} )</p>
            ...
            <div class="row">
                <div class="col-lg-9 mx-auto">
                    <section class="related-posts">
                        <h2 class="section-title mb-4" data-aos="fade-up">Посты этой категории</h2>
                        <div class="row">
                    ...
                    <section class="comment-list mb-5">
                        <h5 class="section-title mb-5" data-aos="fade-up">Комментарии ({{ $post->comments->count() }}):</h5>
                        @foreach($post->comments as $comment)
                        <div class="card-footer card-comments mb-3">
                            <div class="card-comment">
                                <!-- User image -->
                                <img class="img-circle img-sm" src="{{ asset('storage/user8-128x128.jpg') }}" alt="User Image">
                    ...
                    <section class="comment-section">
                        <h5 class="section-title mb-5" data-aos="fade-up">Оставить комментарий</h5>
